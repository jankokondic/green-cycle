...
import { getProjectById, updateProject, searchMaterials } from '../api/api';
import './css/new.css';
        ...
        getProjectById(id)
            .then(data => {
                setForm({
                    ...
                    difficulty: data.project.difficulty || 'easy',
                    time_required: data.project.time_requied || '',
                    is_published: data.project.is_published === 1,
                    ...
                    thumbnail: null,
                    images: [],
                    existingThumbnailUrl: data.project.thumbnail,
                    existingImagesUrls: data.images || [],
                });
            })
